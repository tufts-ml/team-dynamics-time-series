...
1. [_FigureEight_: DSARF](https://github.com/tufts-ml/dsarf_agentformer_baseline_for_hsrdm/dsarf_on_figure_8)
...
4. [MarchingBand: DSARF] (https://github.com/tufts-ml/dsarf_agentformer_baseline_for_hsrdm/dsarf_on_marching)
...
5. [MarchingBand: HSRDM, rAR-HMM, no-recurrence ablation] (src/dynagroup/model2a/marching_band/demo.py)

C. To train baseline forecasts, use: 

1. [_FigureEight_: DSARF Ind., Pool., Concat.](https://github.com/tufts-ml/dsarf_agentformer_baseline_for_hsrdm/dsarf_on_figure_8/DSARF_on_figure_8.ipynb)
2. [Basketball: AgentFormer](https://github.com/tufts-ml/dsarf_agentformer_baseline_for_hsrdm/agentformer_on_bball) 
3. [Basketball: GroupNet](https://github.com/mikewojnowicz/GroupNet/tree/aistats)
4. [MarchingBand: DSARF] (https://github.com/tufts-ml/dsarf_agentformer_baseline_for_hsrdm/dsarf_on_marching/run_marchingband.py)


C. Experiments from the paper can be reproduced by setting the apropriate hyperparameters and running the scripts/notebooks above. Results will either be automatically plotted and saved in the following folders, or can be easily reproduced in the following Jupyter Notebooks: 

1. [_FigureEight_: HSRDM, rAR-HMM](src/dynagroup/model2a/figure8/results/plots/)
2. [_FigureEight_: HSRDM, rAR-HMM Pool.](src/dynagroup/model2a/figure8/results/plots/)
3. [_FigureEight_: HSRDM, rAR-HMM Concat.](src/dynagroup/model2a/figure8/results/plots/)
4. [_FigureEight_: DSARF Ind., Pool., Concat.](https://github.com/tufts-ml/dsarf_agentformer_baseline_for_hsrdm/dsarf_on_figure_8)
...
6. [MarchingBand: HSRDM, rAR-HMM, no-recurrence ablation] (src/dynagroup/model2a/marching_band/results/plots.py)
7. [MarchingBand: DSARF Concat.] (https://github.com/tufts-ml/dsarf_agentformer_baseline_for_hsrdm/dsarf_on_marching/plot_results.ipynb)
