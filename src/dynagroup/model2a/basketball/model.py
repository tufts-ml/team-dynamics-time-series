...
class Model_Type(Enum):
    ...
    Linear_And_OOB_Entity_Recurrence__and__All_Player_Locs_And_Court_Config_System_Recurrence = 8
...
model_basketball_linear_and_out_of_bounds_entity_recurrence__and__all_player_locations_and_court_configuration_system_recurrence = Model(
    compute_log_initial_continuous_state_emissions_JAX,
    compute_log_continuous_state_emissions_after_initial_timestep_JAX,
    compute_log_system_transition_probability_matrices_JAX,
    compute_log_entity_transition_probability_matrices_JAX,
...
def get_basketball_model_from_model_type(model_type: Model_Type) -> Model:
    if model_type == Model_Type.No_Recurrence:
        ...
        model_type
        == Model_Type.Linear_And_OOB_Entity_Recurrence__and__All_Player_Locs_And_Court_Config_System_Recurrence
    ):
        return model_basketball_linear_and_out_of_bounds_entity_recurrence__and__all_player_locations_and_court_configuration_system_recurrence
    else:
