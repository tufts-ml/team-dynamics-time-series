...
def LINEAR_RECURRENCE_transform_of_continuous_state_vector_before_premultiplying_by_entity_recurrence_matrix_JAX(
    x_vec: JaxNumpyArray1D,
) -> JaxNumpyArray1D:
...
def LINEAR_AND_OOB_RECURRENCE_transform_of_continuous_state_vector_before_premultiplying_by_entity_recurrence_matrix_JAX(
    x_vec: JaxNumpyArray1D,
) -> JaxNumpyArray1D:
...
def LINEAR_AND_OOB_AND_COURT_SIDE_RECURRENCE_transform_of_continuous_state_vector_before_premultiplying_by_entity_recurrence_matrix_JAX(
    x_vec: JaxNumpyArray1D,
) -> JaxNumpyArray1D:
    out_of_bounds_to_the_left, out_of_bounds_to_the_right = x_vec[0] < 0.0, x_vec[0] > 1.0
    out_of_bounds_to_the_south, out_of_bounds_to_the_north = x_vec[1] < 0.0, x_vec[1] > 1.0
    left_court_side, right_court_side = x_vec[0] < 0.25, x_vec[0] > 0.75
...
def OOB_RECURRENCE_transform_of_continuous_state_vector_before_premultiplying_by_entity_recurrence_matrix_JAX(
    x_vec: JaxNumpyArray1D,
) -> JaxNumpyArray1D:
    out_of_bounds_to_the_left, out_of_bounds_to_the_right = x_vec[0] < 0.0, x_vec[0] > 1.0
