...
### Configs
load_dir = "results/fig8/external/DSARF_Results_Preetish_2/forecast_npy_files/"
save_dir = "results/fig8/external/DSARF_Results_Preetish_2/forecast_plots_by_mike/"
